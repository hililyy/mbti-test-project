...
<div align=center class="container">
   <section id="main" class="section">
         ...
         <button id="stratTest" type="button" class="btn-gradient purple small" onclick="begin()">START</button>
   </section>
   <section id="qna">
   	<div class="status">
   ...
   <form name="getresult" action="result.jsp" method="POST">
   	<h1>내 결과 보러가기!</h1>
   	<input id="userId" name="userId" hidden value=<% request.getAttribute("userId"); %>type="text" >
